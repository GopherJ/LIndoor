...
L.LabeledMarker = L.FeatureGroup.extend({
     ...
     * @return {L.LatLng}
     */
        getLabelPosition: (marker, feature, latlng) => (feature.properties.labelPosition
   ...
   */
    _createLayers() {
        ...
        this._marker = new L.TextCircle(text, pos,
            ...
            opts.markerOptions)).on('drag', this._onMarkerDrag, this)
...
L.labeledCircleMarker = (latlng, feature, options) => new L.LabeledMarker(latlng, feature, options);
